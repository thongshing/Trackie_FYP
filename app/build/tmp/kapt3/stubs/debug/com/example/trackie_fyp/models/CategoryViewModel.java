...
public final class CategoryViewModel extends androidx.lifecycle.AndroidViewModel {
    ...
    public final void loadCategories(int userId) {
    }
    ...
    public final void deleteCategory(int categoryId, int userId) {
    }
}